...
<jsp:useBean id="Participante" type="pe.edu.pucp.iweb.lab9.lab9_grupo9.Beans.Participante" scope="request" class="pe.edu.pucp.iweb.lab9.lab9_grupo9.Beans.Participante"/>
                ...
                <div class="w-75">
                    <form method="POST" action="<%=request.getContextPath()%>/ParticipanteServlet?action=editar&id=<%=Participante.getIdParticipante()%>">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" value="<%=Participante.getEdad()%>" name="edadParticipante" id="edadParticipante">
                        </div>
                        <div class="form-group">
